...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////Users/alexkamer/mmaWebsite/data/mma.db'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///data/mma.db'

app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)

# Database configuration
# SQLALCHEMY_DATABASE_URL = "sqlite:////Users/alexkamer/mmaWebsite/data/mma.db"
