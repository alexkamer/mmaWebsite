...
class Linescore(Base):
    ...
    league_event_id_fight_id_fighter_id = Column(String, doc="The event id, fight id, and fighter id of the linescore", primary_key=True)
    league = Column(String, doc="The league of the linescore")
    event_id = Column(Integer, doc="The event id of the linescore")
    fight_id = Column(Integer, doc="The fight id of the linescore")
    fighter_id = Column(Integer, doc="The fighter id of the linescore")
    score_value = Column(Integer, nullable=True, doc="The score value of the linescore")
    judge_1_score = Column(Integer, nullable=True, doc="The score of the first judge of the linescore")
    judge_2_score = Column(Integer, nullable=True, doc="The score of the second judge of the linescore")
    judge_3_score = Column(Integer, nullable=True, doc="The score of the third judge of the linescore")
